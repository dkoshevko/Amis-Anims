  ...
  async function addGame() {
    ...
    const postData = {
      ...
      body: JSON.stringify({
        ...
        game_number_of_children: gameNumberOfChildren,
        game_preparation_time: gamePreparationTime,
        game_necessary_material: gameNecessaryMaterial,
        game_goal: gameGoal,
        game_advices: gameAdvices,
